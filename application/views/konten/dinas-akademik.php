...
<body>
  ...
  <main>
    ...
    <div class="struktural-dinas">
      <h1 class="text-center">>> Struktural Dinas <<</h1> <div class="group-dinas struktural-dinas-kadin">
    ...
    <!--Carousel Wrapper-->
    <h1 class="text-center marg">>> Program Kerja Dinas <<</h1> <div id="carousel-example-1" class="carousel slide carousel-fade" data-ride="carousel" style="margin: 0px 50px;">
        <!--Indicators-->
