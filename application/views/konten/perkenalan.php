	...
	<!--Carousel Wrapper-->
		<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel" >
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-caption">
					<a ><h1 class="h1-responsive">Open Recruitment</h1></a>
				...
				<div class="carousel-caption">
					<a ><h1 class="h1-responsive">Apresiasi Mahasiswa</h1></a>
				...
				<div class="carousel-caption">
					<a ><h1 class="h1-responsive">Tech Story</h1></a>
					<p>Hololens</p>
				</div>
				</div>
				<div class="carousel-item">
				...
				<div class="carousel-caption">
					<a ><h1 class="h1-responsive">Informasi Penting</h1></a>
		...
		<div class="kata-sambutan">
			...
			<div class="disp-cont">
					...
					<img src="<?php echo base_url('assets/Logo/rafi-circle.png'); ?>" style=" width: 300px;">
					<div class="txt-bpt">
